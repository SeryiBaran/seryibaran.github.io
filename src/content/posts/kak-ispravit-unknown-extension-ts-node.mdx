...
<Alert>[Раздел про ESM/CJS в документации ts-node](https://typestrong.org/ts-node/docs/imports).</Alert>
<Alert>Если вам нужна инструкция от разработчиков, почитайте [это](https://github.com/TypeStrong/ts-node#err_unknown_file_extension).</Alert>
