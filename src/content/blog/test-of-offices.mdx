...
Я протестировал 5 (7 если считать версии) офисных пакетов на тестовом DOCX файле от Calibri.
...
3. Яндекс Документы (пропал маркер в виде градиента в конце страницы + проблемы верхнего пункта)
4. Google Docs (чудовищно поплыли буквицы, таблицы и рамки таблиц + проблемы верхнего пункта)
5. Kingsoft Office Writer 2012 (слетели все настройки шрифтов кроме цвета)
