...
Подходит к любой версии шины. Невероятно быстрый и оптимизированный.

Адреса суммируются, т.е. если подключить 8x8 сетку `switches`, макс возможный адрес будет 1024 + 1 (Присутствует лишний адрес - пустые сортеры, т.е. 8x8 сетка даст не 1024 а 1025 адресов), но это бесполезно т.к. макс банка памяти на 512 адресов.
...
```plaintext

```
...
```plaintext
set firstLinks:1:4 3
set lastLinks:2:4 1
op sub &t0 @links firstLinks:1:4
op sub sorters:3:4 &t0 lastLinks:2:4
set addr:4:4 0
set i:6:9 firstLinks:1:4
op add &t1 firstLinks:1:4 sorters:3:4
jump 60 greaterThan i:6:9 &t1
getlink &t2 i:6:9
sensor &t3 &t2 @config
jump 27 strictEqual &t3 @copper
jump 29 strictEqual &t3 @lead
jump 31 strictEqual &t3 @metaglass
jump 33 strictEqual &t3 @graphite
jump 35 strictEqual &t3 @sand
jump 37 strictEqual &t3 @coal
jump 39 strictEqual &t3 @titanium
jump 41 strictEqual &t3 @thorium
jump 43 strictEqual &t3 @scrap
jump 45 strictEqual &t3 @silicon
jump 47 strictEqual &t3 @phase-fabric
jump 49 strictEqual &t3 @plastanium
jump 51 strictEqual &t3 @surge-alloy
jump 53 strictEqual &t3 @spore-pod
jump 55 strictEqual &t3 @blast-compound
jump 57 strictEqual &t3 @pyratite
jump 58 always
op add addr:4:4 addr:4:4 1
jump 58 always
op add addr:4:4 addr:4:4 2
jump 58 always
op add addr:4:4 addr:4:4 3
jump 58 always
op add addr:4:4 addr:4:4 4
jump 58 always
op add addr:4:4 addr:4:4 5
jump 58 always
op add addr:4:4 addr:4:4 6
jump 58 always
op add addr:4:4 addr:4:4 7
jump 58 always
op add addr:4:4 addr:4:4 8
jump 58 always
op add addr:4:4 addr:4:4 9
jump 58 always
op add addr:4:4 addr:4:4 10
jump 58 always
op add addr:4:4 addr:4:4 11
jump 58 always
op add addr:4:4 addr:4:4 12
jump 58 always
op add addr:4:4 addr:4:4 13
jump 58 always
op add addr:4:4 addr:4:4 14
jump 58 always
op add addr:4:4 addr:4:4 15
jump 58 always
op add addr:4:4 addr:4:4 16
op add i:6:9 i:6:9 1
jump 6 always
print addr:4:4
printflush message1
set work:70:4 1
control enabled switch1 work:70:4
jump 69 equal work:70:4 0
read &t1 bank1 addr:4:4
write &t1 cell1 0
sensor work:70:4 switch1 @enabled
jump 64 always
end
```
...
- сделать панель и передатчик Uni, передатчик будет настраиваться на количество каналов по кнопкам
